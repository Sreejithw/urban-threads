import {
  ...
  const newDateFormat = new Intl.DateTimeFormat('en', { dateStyle: 'medium' });
  
  export default function PaymentReceiptEmail({ order }: {order: Order}) {
    return (
      <Html>
            ...
            <Container className='max-w-xl'>
                ...
                <Row>
                    ...
                    <Text className='mt-0 mr-4'>
                        {newDateFormat.format(order.creationTime)}
                    </Text>
                    </Column>
                    <Column>
                    <Text className='mb-0 text-gray-500 whitespace-nowrap text-nowrap mr-4'>
                ...
                {[
                    ...
                    { name: 'Tax', price: order.taxAmount },
                    { name: 'Shipping', price: order.shippingPrice },
                    { name: 'Total', price: order.grandTotal },
                ].map(({ name, price }) => (
